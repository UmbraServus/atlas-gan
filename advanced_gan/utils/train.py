from models.basline_adv_gan import Generator, Discriminator
from utils import preprocess as prep
from configs import hyper_params_baseline as hp
# Training function
...
def train_dcgan(dataloader, num_epochs, batch_size):
  ...
  for epoch in range(num_epochs):
    for i, (real_imgs,_) in enumerate(dataloader):
      ...
      fake_labels = torch.zeros(curr_batch_size, 1).to(device) + 0.02 
    ...
    log_interval = 100  # log every 10 batches
...
# Save final models
  torch.save(generator.state_dict(), "baseline_generator.pth")
  torch.save(discriminator.state_dict(), "baseline_discriminator.pth")
  wandb.save("base_generator.pth")
  wandb.save("base_discriminator.pth")
